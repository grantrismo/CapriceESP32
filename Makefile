...
$(APP_FW): $(APP_BIN)
	@echo MKFW $@
	@$(MKFW) "$(PROJECT_NAME)($(VERSION))" media/tile.raw 0 16 1376256 "$(PROJECT_NAME)" $^
	@mv firmware.fw $@
	@cp -f build/caprice-esp32.fw release/caprice-esp32.fw
	@cp -f build/caprice-esp32.elf release/caprice-esp32.elf
