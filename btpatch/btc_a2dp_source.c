...
#define DEFAULT_SBC_BITRATE                    452 //328 Odroid
...
void btc_a2dp_source_setup_codec(void)
{
    ...
    /* for now hardcode 44.1/2 khz 16 bit stereo PCM format */
...
static void btc_a2dp_source_enc_init(BT_HDR *p_msg)
{
    ...
    btc_aa_src_cb.encoder.s16ChannelMode = SBC_DUAL; //pInitAudio->ChannelMode; //patch
...
static void btc_a2dp_source_pcm2sbc_init(tBTC_MEDIA_INIT_AUDIO_FEEDING *p_feeding)
{
    ...
    btc_aa_src_cb.encoder.s16ChannelMode = SBC_DUAL; //patch
    reconfig_needed = TRUE; //patch
